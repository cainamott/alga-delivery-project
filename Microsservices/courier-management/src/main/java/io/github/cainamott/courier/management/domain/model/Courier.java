package io.github.cainamott.courier.management.domain.model;
...
public class Courier {
    ...
    private Integer pendidngDeliveriesQuantity;

    private Integer fulfilledDeliveriesQuantity;

    private OffsetDateTime lastFullfilledDelivery;
    ...
    public void fulfill(UUID deliveryId){
        ...
        this.lastFullfilledDelivery = OffsetDateTime.now();
    }
}
